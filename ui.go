...
func (ps *PlayerState) renderHelp() string {
	...
	case ModeEdit, ModeEditInput, ModeEditSearch, ModeEditSearching, ModeEditCoverInput, ModeEditApply:
		modeLabel = "Edit"
...
func (ps *PlayerState) View() string {
	...
	if ps.mode == ModeEdit || ps.mode == ModeEditInput || ps.mode == ModeEditSearch || ps.mode == ModeEditSearching || ps.mode == ModeEditCoverInput || ps.mode == ModeEditApply {
